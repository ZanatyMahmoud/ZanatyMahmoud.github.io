...
<section id="contact" class="section container contact">{heading('06',c['nav'][5],c['contactTitle'])}<p>{e(c['contactText'])}</p><a class="email-link" href="mailto:acc.m.zanaty@gmail.com" aria-label="{e(c['emailLabel'])}: acc.m.zanaty@gmail.com"><bdi>acc.m.zanaty@gmail.com</bdi><span aria-hidden="true">↗</span></a><div class="actions professional-links"><a class="button secondary" href="https://www.linkedin.com/in/zanaty-mahmoud-m7z001" target="_blank" rel="noopener noreferrer">{'صفحتي على LinkedIn' if lang == 'ar' else 'My LinkedIn profile'}<span aria-hidden="true">↗</span></a></div><div class="contact-bottom"><p>{e(c['location'])}</p><a class="button secondary print-button" href="./assets/cv/Mahmoud-El-Zanaty-CV-{lang.upper()}.pdf" download="Mahmoud-El-Zanaty-CV-{lang.upper()}.pdf">{'تحميل السيرة الذاتية PDF' if lang == 'ar' else 'Download CV (PDF)'}<span aria-hidden="true">↓</span></a></div></section>
